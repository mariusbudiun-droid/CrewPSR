    ...
    <div style="display:flex;gap:16px;margin-top:10px;flex-wrap:wrap">
      ${ft > 0 ? `
        <div style="display:flex;flex-direction:column;gap:2px">
          <span style="font-size:11px;font-weight:700;letter-spacing:0.6px;text-transform:uppercase;color:var(--text3)">
            Flight Time
          </span>
          <span style="font-family:'JetBrains Mono',monospace;font-size:18px;font-weight:800;line-height:1;color:var(--blue)">
      ...
      ${dp > 0 ? `
        <div style="display:flex;flex-direction:column;gap:2px">
          ...
          <span style="font-family:'JetBrains Mono',monospace;font-size:18px;font-weight:800;line-height:1;color:#f59e0b">
